...
class Process:
    ...
    def __init__(self, id: int, execution_sequence: list[int], sys_proc: bool, release_time: int = 0, memory_required: int = 0) -> None:
        ...
        # Queue of SysCallRequest objects; used only when sys_proc=True
        self._sys_queue: deque[SysCallRequest] = deque()

        # Affinity (most-recently-used CPU list) 
        # Stores the IDs of CPUs this process has run on, most recent last.
        # The scheduler uses this to prefer the most recent CPU.
